...
double streetCuriosity(Street street) {
    switch (street) {
    case Street::preflop: return 0.62; // Pay to see a flop.
    case Street::flop: return 0.82; // Pay to see the turn.
    case Street::turn: return 0.68; // Pay to see the river.
    case Street::river: return 0.36; // Pay to see showdown.
    default: return 0.0;
    }
}
...
ReferenceDecision VirgoReferencePlayer::chooseResponse(const TableView& privateView, std::mt19937_64&) const {
    ...
    // This is a public-information probability estimate: board texture and the
    // number of live opponents establish the prior, then their betting updates it.
