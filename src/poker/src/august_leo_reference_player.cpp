...
AugustLeoReferencePlayer::AugustLeoReferencePlayer(std::string name, AugustLeoReferencePlayerProfile profile)
...
std::vector<ReferencePlayerParameter> AugustLeoReferencePlayer::parameters() const {
    return {{"Risk Tolerance", profile_.riskTolerance}, {"Optimism", profile_.optimism}, {"Variability", profile_.variability}};
}

ReferenceDecision AugustLeoReferencePlayer::chooseResponse(const TableView& privateView, std::mt19937_64& random) const {
