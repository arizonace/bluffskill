...
public:
    ...
    // Presentation pauses are server-authoritative so they do not advance the
    // time-based blind schedule.
...
private:
    ...
    std::chrono::steady_clock::time_point blindClockPausedAt_{std::chrono::steady_clock::now()};
